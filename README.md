...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-29 21:15`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8ebae4d4-323e-4d3d-a213-35d65bf30acc.git
$ cd 8ebae4d4-323e-4d3d-a213-35d65bf30acc
```
